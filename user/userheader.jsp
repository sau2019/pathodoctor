		  ...
		  <header id="header">
	  		<div class="header-top">
	  			<div class="container">
					...
					<% out.print(session.getAttribute("name"));  %></h5>
					 	</div>
					  </div>		  					
	  			</div>
			</div>
		    	...
		    	<div class="row align-items-center justify-content-between d-flex">
			      ...
			      <nav id="nav-menu-container">
			        <ul class="nav-menu">
			          ...
			          <li><a href="userdash.jsp" id="uhome">Home</a></li>
			          <li><a href="#" id="udoctor">Doctors</a></li>
			          <li><a href="usertest.jsp" id="utestcard">Test Card</a></li>
			          <li></li>
  
			          	<li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true" id="services">Services</a>
          <ul class="dropdown-menu">
            <li><a href="resetpassword.jsp" id="changepass">ChangePassword</a></li>
            <li><a href="usertest.jsp">Appointment List</a></li>
            ...
            <li><a href="#">One more separated link</a></li>
			          ...
			          <li><a href="userlogout.jsp">Logout<img src="../icon/logout.png"  height="20px" width="20px" ></a></li>
         ...
         <h1>X</h1>
			...
			<div class="row">
			 		...
			 		<ul>
						...
						<li><a href="usertest.jsp">Testcard</a></li>
