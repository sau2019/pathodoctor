...
String qry1="update register set password='"+md5_encoded_pass +"'  where id="+ session.getAttribute("userid")+" and email='" +email+"' ";
...
<button class="btn btn-danger btn-sm"><a href="userdash.jsp">Go to Dashboard.</a></button>