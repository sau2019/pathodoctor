...
<%
    ...
    //out.println("storing hash md5 in a variable:"+md5_encoded_pass);
        ...
        String qry4="insert into register(name,gender,address,email,mobile,password,hint) values('" + name + "', '" + gender + "','"+address +"','"+ email +"','"+ mobile +"','"+ md5_encoded_pass +"','"+ hint +"')";
   ...
   %>
    ...
    <p />
      ...
      <a href="../login.jsp"><button class="btn btn-primary">Login Page</button> </a>
</center>
